...
static uint8_t message[] =
  ...
  "only ones so far are open, save, close, quit, eval. Open, save, "
  "close and quit do pretty much what you would expect. With the eval "
  "command you can add new functions or evaluate lua code in runtime "
