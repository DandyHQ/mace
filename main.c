...
"\n"
"What you probably see right now is two lines and a text box (containing this\n"
"tutorial). The first line is a list of tabs that Mace has opened for you. If\n"
"you start Mace by giving it file names, Mace will start with those files open.\n"
"Further on you will find out how to open new tabs. The next line is called\n"
"the action bar. It is a text box the same as this one. It will wrap and grow\n"
"as needed. The purpose of the action bar is to have a place for commands that\n"
"you are using with the current file and as a general scratch area. Commands\n"
"will be explained later on. The main text box below is where files you have\n"
"opened go.\n"
"\n"
...
"(and sometimes dragging) the scroll bar. In Mace the scroll bar doesn't work\n"
" how it does in many modern graphical user interfaces. In Mace a left click\n"
"will scroll the text box up and a right will scroll down, while a middle click\n"
"will take you to that immediate position, which you can then drag around. For\n"
"left and right clicks the position of the click in the scroll bar matters. A\n"
...
"- shifttab: Un-indents the selection regions.\n"
...
"\n"
"So yes, Mace has unlimited undo in the form of a tree that you can not see.\n"
"If you actually figure out how to navigate through the tree I will be impressed.\n"
"\n"
